...
- [Github](https://github.com/jaredlll08/Clumps) <Icon name="simple-icons:github" size="1.2em" class="inline-icon" />
- [Modrinth](https://modrinth.com/mod/clumps) <Icon name="simple-icons:modrinth" size="1.2em" class="inline-icon" />
- [CurseForge](https://www.curseforge.com/minecraft/mc-mods/clumps) <Icon name="simple-icons:curseforge" size="1.2em" class="inline-icon" />
