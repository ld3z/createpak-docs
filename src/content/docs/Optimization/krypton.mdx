...
- [Github](https://github.com/astei/krypton) :simple-icons-github:
- [Modrinth](https://modrinth.com/mod/krypton) :simple-icons-modrinth:
- [CurseForge](https://www.curseforge.com/minecraft/mc-mods/krypton) :simple-icons-curseforge:
