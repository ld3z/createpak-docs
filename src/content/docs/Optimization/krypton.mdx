...
- [Github](https://github.com/astei/krypton) <Icon name="simple-icons:github" size="1.2em" />
- [Modrinth](https://modrinth.com/mod/krypton) <Icon name="simple-icons:modrinth" size="1.2em" />
- [CurseForge](https://www.curseforge.com/minecraft/mc-mods/krypton) <Icon name="simple-icons:curseforge" size="1.2em" />
