...
- [Github](https://github.com/embeddedt/ModernFix) <Icon name="simple-icons:github" size="1.2em" />
- [Modrinth](https://modrinth.com/mod/modernfix) <Icon name="simple-icons:modrinth" size="1.2em" />
- [CurseForge](https://www.curseforge.com/minecraft/mc-mods/modernfix) <Icon name="simple-icons:curseforge" size="1.2em" />
