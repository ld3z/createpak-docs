...
- [Github](https://github.com/isXander/Debugify) :simple-icons-github:
- [Modrinth](https://modrinth.com/mod/debugify) :simple-icons-modrinth:
- [CurseForge](https://www.curseforge.com/minecraft/mc-mods/debugify) :simple-icons-curseforge:
