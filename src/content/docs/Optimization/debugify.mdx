...
- [Github](https://github.com/isXander/Debugify) <Icon name="simple-icons:github" size="1.2em" />
- [Modrinth](https://modrinth.com/mod/debugify) <Icon name="simple-icons:modrinth" size="1.2em" />
- [CurseForge](https://www.curseforge.com/minecraft/mc-mods/debugify) <Icon name="simple-icons:curseforge" size="1.2em" />
